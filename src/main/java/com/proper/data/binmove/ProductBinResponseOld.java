...
/**
 * Created by Lebel on 08/05/2014.
 */
public class ProductBinResponseOld implements Serializable {
    ...
    public ProductBinResponseOld() {
    }

    public ProductBinResponseOld(int productId, String supplierCat, String artist, String title, String barcode, String format, String EAN, String suppCode, int stockAmount, int deletionType, String fullArtist, String fullTitle, int qtyInBin) {
        ProductId = productId;
