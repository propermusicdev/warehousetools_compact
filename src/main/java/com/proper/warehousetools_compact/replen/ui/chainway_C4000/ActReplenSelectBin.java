 ...
 */
public class ActReplenSelectBin extends BaseScannerActivity {
            ...
            if (s != null && !s.toString().equalsIgnoreCase("")) {
                if (inputByHand == 0) {
                    ...
                    if (eanCode.length() > 0 && eanCode.length() == 5) {
                        ...
                        new AlertDialog.Builder(ActReplenSelectBin.this).setTitle(R.string.DIA_ALERT).setMessage(R.string.DEV_EAN_ERR).setPositiveButton(R.string.DIA_CHECK, new DialogInterface.OnClickListener() {
                            @Override
    ...
    private class WebServiceTask extends AsyncTask<com.proper.messagequeue.Message, Void, BinResponse>{
        ...
        protected void onPreExecute() {
            ...
            xDialog = new ProgressDialog(ActReplenSelectBin.this);
        ...
        protected void onPostExecute(BinResponse response) {
            ...
            //lockAllControls();
            if (response != null) {
                //Intent i = new Intent(ActReplenSelectBin.this, ActReplenManage.class);
                Intent i = new Intent(ActReplenSelectBin.this, ActReplenSelectProduct.class);
