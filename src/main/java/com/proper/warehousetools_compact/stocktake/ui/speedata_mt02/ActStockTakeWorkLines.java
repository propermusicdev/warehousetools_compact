 ...
 */
public class ActStockTakeWorkLines extends BaseScannerActivityLegacy implements IStockTakeQtyCommunicator {
    ...
    private void buttonClicked(View v) {
        ...
        if (v == btnScan) {
            ...
            try {
                ...
                LogEntry log = new LogEntry(1L, ApplicationID, "ActStockTakeWorkLines - buttonClicked", deviceIMEI, e.getClass().getSimpleName(), e.getMessage(), today);
                logger.log(log);
            }
            btnScan.setEnabled(true);
        }
